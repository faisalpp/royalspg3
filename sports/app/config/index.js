export default {
  ...
  API: {
    LIVE_ENDPOINT: 'https://api.b365api.com/v1/bwin/inplay',
    PRE_ENDPOINT: 'https://api.b365api.com/v1/bwin/prematch',
    RESULT_ENDPOINT: 'https://api.b365api.com/v1/bwin/result',
    EVENT_ENDPOINT: 'https://api.b365api.com/v1/bwin/event',
    LIVE_TIME: '*/30 * * * * *',
    UPCOMIN_TIME: '*/60 * * * * *',
    END_TIME: '*/60 * * * * *',
    PRE_TIME: '*/30 * * * *',
